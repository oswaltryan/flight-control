...
DEFAULT_REPLAY_PRE_FAIL_DURATION_SEC = 30.0
DEFAULT_REPLAY_POST_FAIL_DURATION_SEC = 10.0
...
ROI_SIZE_STANDARD_KEYPAD = (40, 40) # Wider for 3-column layout
